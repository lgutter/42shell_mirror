...
Test(builtin_type_unit, invalid_NULL_shell_find_ls, .init = redirect_both)
{
	char	**argv = ft_strsplit_t_s("type ls");
	char	*expected_output = "ls not found\n";
...
Test(builtin_type_unit, valid_find_non_existent, .init = cr_redirect_stdout)
{
	t_shell	*shell = init_shell(false);
...
Test(builtin_type_unit, valid_find_directory, .init = cr_redirect_stdout)
{
	t_shell	*shell = init_shell(false);
...
Test(builtin_type_unit, valid_find_all, .init = cr_redirect_stdout)
{
	t_shell	*shell = init_shell(false);
